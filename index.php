...
<body>
	...
	<div class="container">
		<header>
			<h1><strong>Sistem Informasi Tugas Kuliah</strong></h1>
			<hr>
		</header>
					...
					<form action="" method="POST" role="form">
						...
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<label><input type="radio" name="jenis" value="0" /> Kelompok</label>
								</fieldset>
							</div>
							<div class="form-group">
	...
	<div class="footer">
		<hr/>
		<div style="text-align: right;"> &copy; <?= date('Y'); ?> <a href="https://www.youtube.com/@asalngodingofficial" target="_blank">@asalngodingofficial</a></div>
	</div>
